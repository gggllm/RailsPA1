...
class SegmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create segment" do
    assert_difference('Segment.count') do
      post segments_url, params: { segment: { course_id: @segment.course_id, id: @segment.id, subject_id: @segment.subject_id } }
    end
  ...
  test "should update segment" do
    patch segment_url(@segment), params: { segment: { course_id: @segment.course_id, id: @segment.id, subject_id: @segment.subject_id } }
